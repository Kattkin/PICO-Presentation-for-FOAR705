...
\usetheme{Hannover}
\usepackage{beamerthemesplit} \usepackage[orientation=landscape,size=custom,width=12.7,height=7.20,scale=0.5,debug]{beamerposter}  %maps it to the screen orientation
